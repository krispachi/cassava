    ...
    <div class="w-layout">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-10">
            <a href="{{ route('home.index') }}"
               class="{{ !$selectedAngkatan ? 'bg-primakara-blue text-white' : 'bg-primakara-light text-primakara-blue hover:bg-primakara-blue/10' }} px-4 py-2 rounded-md text-sm font-medium transition">
                Semua Angkatan
            </a>
            @foreach($angkatanList as $angkatan)
                <a href="{{ route('home.index', ['angkatan' => $angkatan]) }}"
                   class="{{ $selectedAngkatan == $angkatan ? 'bg-primakara-blue text-white' : 'bg-primakara-light text-primakara-blue hover:bg-primakara-blue/10' }} px-4 py-2 rounded-md text-sm font-medium transition">
                    Angkatan {{ $angkatan }}
                </a>
            @endforeach
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="flex flex-col items-center transform md:translate-y-8">
                <div class="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-4 border-primakara-light mb-3">
                    <img src="{{ asset('images/primakara-logo.png') }}" alt="{{ $topThree[1]->name }}" class="w-full h-full object-cover bg-white p-1">
                </div>
                <div class="bg-white rounded-xl shadow-lg p-5 text-center w-full">
                    ...
                    <h3 class="font-bold text-primakara-dark-gray text-lg">{{ $topThree[1]->name }}</h3>
                    <p class="text-sm text-primakara-medium-gray mb-2">{{ $topThree[1]->prodi }}</p>
                    <div class="text-primakara-blue font-bold text-xl">{{ $topThree[1]->total_tak }} Poin</div>
                </div>
            </div>
            @endif
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-yellow-400 mb-3">
                    <img src="{{ asset('images/primakara-logo.png') }}" alt="{{ $topThree[0]->name }}" class="w-full h-full object-cover bg-white p-2">
                </div>
                <div class="bg-primakara-blue text-white rounded-xl shadow-lg p-5 text-center w-full">
                    ...
                    <h3 class="font-bold text-white text-xl">{{ $topThree[0]->name }}</h3>
                    <p class="text-sm text-white/80 mb-2">{{ $topThree[0]->prodi }}</p>
                    <div class="text-white font-bold text-2xl">{{ $topThree[0]->total_tak }} Poin</div>
                </div>
            </div>
            @endif
            ...
            <div class="flex flex-col items-center transform md:translate-y-12">
                <div class="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-4 border-primakara-light mb-3">
                    <img src="{{ asset('images/primakara-logo.png') }}" alt="{{ $topThree[2]->name }}" class="w-full h-full object-cover bg-white p-1">
                </div>
                <div class="bg-white rounded-xl shadow-lg p-5 text-center w-full">
                    <div class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 mb-3">
                        <span class="text-lg font-bold text-primakara-medium-gray">3</span>
                    </div>
                    <h3 class="font-bold text-primakara-dark-gray text-lg">{{ $topThree[2]->name }}</h3>
                    <p class="text-sm text-primakara-medium-gray mb-2">{{ $topThree[2]->prodi }}</p>
                    <div class="text-primakara-blue font-bold text-xl">{{ $topThree[2]->total_tak }} Poin</div>
                </div>
            </div>
            @endif
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="divide-y divide-primakara-light">
                @foreach($remainingRanks as $mahasiswa)
                <!-- Row {{ $mahasiswa->rank }} -->
                <div class="px-6 py-4 grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-center hover:bg-primakara-gray/30 transition">
                    <div class="flex md:block col-span-1 text-center font-medium text-primakara-medium-gray">
                        <span class="inline-block w-8 md:w-auto md:mb-0 mr-3 md:mr-0">{{ $mahasiswa->rank }}</span>
                        <img src="{{ asset('images/primakara-logo.png') }}" alt="{{ $mahasiswa->name }}" class="md:hidden w-10 h-10 rounded-full mr-3 bg-white p-1">
                    </div>
                    <div class="flex items-center md:col-span-6">
                        <img src="{{ asset('images/primakara-logo.png') }}" alt="{{ $mahasiswa->name }}" class="hidden md:block w-10 h-10 rounded-full mr-3 bg-white p-1">
                        <span class="font-medium text-primakara-dark-gray">{{ $mahasiswa->name }}</span>
                    </div>
                    <div class="col-span-3 text-primakara-medium-gray text-sm md:text-base">{{ $mahasiswa->prodi }}</div>
                    <div class="col-span-2 text-right font-bold text-primakara-blue">{{ $mahasiswa->total_tak }} Poin</div>
                </div>
                @endforeach

                @if($remainingRanks->count() == 0)
                <div class="px-6 py-8 text-center text-primakara-medium-gray">
                    <i class="fas fa-trophy text-4xl mb-4 opacity-50"></i>
                    <p>Belum ada data leaderboard untuk filter yang dipilih.</p>
                </div>
                @endif
            </div>
        </div>
