                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset("AdminLTE4/dist/assets/img/user1-128x128.jpg") }}" alt="User Avatar"
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset("AdminLTE4/dist/assets/img/user8-128x128.jpg") }}" alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset("AdminLTE4/dist/assets/img/user3-128x128.jpg") }}" alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                <img src="{{ asset("AdminLTE4/dist/assets/img/user2-160x160.jpg") }}" class="rounded-circle shadow"
                                    alt="User Image" />
                                <p>
                                ...
                                <div class="card-body p-0">
                                    <div class="px-2">
                                        <div class="d-flex border-top py-2 px-1">
                                            <div class="col-2">
                                                <img src="{{ asset("AdminLTE4/dist/assets/img/default-150x150.png") }}"
