                        ...
                        <form action="{{ route("users.update", $user->id) }}" method="POST" id="formUbah">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nim" id="nim" class="form-control @error("nim") is-invalid @enderror" value="{{ old("nim", $user->nim) }}" placeholder="Masukkan NIM User (ex: 22010XXX)" required @error("nim") autofocus @enderror>
