                        ...
                        <form action="{{ route("users.store") }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nim" id="nim" class="form-control @error("nim") is-invalid @enderror" value="{{ old("nim") }}" placeholder="Masukkan NIM User (ex: 22010XXX)" required @error("nim") autofocus @enderror>
                                    <small class="form-text text-muted">
                                        Format: 2 digit pertama (tahun angkatan) + 3 digit kode prodi + nomor urut. <br>
                                        Contoh: 22010001 = Angkatan 2022, Prodi Teknik Informatika
                                    </small>
                                    @error("nim")
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                <button type="submit" class="btn btn-success"><i class="fa-solid fa-plus me-2"></i>Tambah User</button>
                                <a href="{{ route("users.index") }}" class="btn btn-secondary ms-auto"><i class="fa-solid fa-arrow-left me-2"></i>Kembali</a>
                            </div>
                        </form>
                    </div>
